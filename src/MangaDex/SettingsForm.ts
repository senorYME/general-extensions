...
import { getAccessToken,
    ...
    setLanguages,
    setRatings,
    setSkipSameChapter } from './MangaDexSettings'
import { MDLanguages,
    MDRatings } from './MangaDexHelper'
        ...
        return [
                ...
                DeferredItem(() => {
                    if (getAccessToken()) {
                        return NavigationRow('sessionInfo', {
                            ...
                            form: new class extends Form {
                                override getSections(): Application.FormSectionElement[] {
                                    ...
                                    return [
                                        Section('introspect', Object.keys(accessToken.tokenBody).map((key) => {
                                            return LabelRow(key, {
                                                title: key,
                        ...
                        return OAuthButtonRow('oAuthButton', {
                            ...
                            onSuccess: Application.Selector(this as SettingsForm, 'oauthDidSucceed')
                        })
                    }
                })
            ]),
            ...
            Section('contentSettings', [
                SelectRow('languages', {
                    ...
                    onValueChange: Application.Selector(this as SettingsForm, 'languageDidChange')
                }),
                ...
                SelectRow('ratings', {
                    ...
                    onValueChange: Application.Selector(this as SettingsForm, 'ratingDidChange')
                }),

                ToggleRow('data_saver', {
                    title: 'Data Saver',
                    value: dataSaver,
                    onValueChange: Application.Selector(this as SettingsForm, 'dataSaverDidChange')
                }),

                ToggleRow('skip_same_chapter', {
                    title: 'Skip Same Chapter',
                    value: skipSameChapter,
                    onValueChange: Application.Selector(this as SettingsForm, 'skipSameChapterDidChange')
                }),

                ToggleRow('force_port', {
                    title: 'Force Port 433',
                    value: forcePort,
                    onValueChange: Application.Selector(this as SettingsForm, 'forcePortDidChange')
                })
            ])
        ]
    }
